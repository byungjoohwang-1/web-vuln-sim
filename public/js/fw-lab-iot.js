...
window.FW_LAB_DATA = {
  host: {"name": "fw-workbench", "device": "CamEye C-210 (IP 카메라)", "arch": "ARM (32-bit, little-endian)", "prompt": "analyst@fw-lab:~/cameye.extracted$", "image": {"file": "cameye_c210_fw_1.4.img", "encrypted": false, "binwalk": [{"dec": 0, "hex": "0", "desc": "JFFS2 filesystem, little endian"}, {"dec": 131072, "hex": "20000", "desc": "uImage header, OS: Linux, CPU: ARM"}, {"dec": 131200, "hex": "20080", "desc": "LZMA compressed data"}, {"dec": 917504, "hex": "e0000", "desc": "Squashfs filesystem, little endian, version 4.0"}]}, "nvram": {}},
  fs: {
 "/": {
  "dir": true
 },
