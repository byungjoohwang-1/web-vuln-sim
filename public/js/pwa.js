...
(function () {
  ...
  function showInstall() {
    ...
    b.id = 'wvs-install';
    b.style.cssText = 'position:fixed;right:var(--wvs-edge,14px);bottom:calc(var(--wvs-edge,14px) + 52px);z-index:var(--wvs-z-banner,500);background:#0e1f17;border:1px solid #14532d;color:#bbf7d0;border-radius:12px;padding:11px 14px;font-family:Segoe UI,Malgun Gothic,sans-serif;font-size:13px;box-shadow:0 8px 24px rgba(0,0,0,.4);display:flex;gap:10px;align-items:center;max-width:280px';
  ...
  function showUpdate(reg) {
    ...
    var b = document.createElement('div');
    b.id = 'wvs-update';
    b.style.cssText = 'position:fixed;left:50%;bottom:var(--wvs-edge,14px);transform:translateX(-50%);z-index:var(--wvs-z-banner,500);background:#0a101e;border:1px solid #1e3a5f;color:#e2e8f0;border-radius:12px;padding:11px 14px;font-family:Segoe UI,Malgun Gothic,sans-serif;font-size:13px;box-shadow:0 8px 24px rgba(0,0,0,.4);display:flex;gap:10px;align-items:center';
